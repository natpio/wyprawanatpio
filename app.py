...
# Wczytanie tabel z Google Sheets do pamięci podręcznej
    ...
    with col_timeline:
        ...
        if df_p is not None and not df_p.empty:
            ...
            with st.expander("⚙️ Tryb Edycji Harmonogramu"):
                ed_p = st.data_editor(df_p, hide_index=True, num_rows="dynamic")
...
with t2:
    ...
    if df_z is not None and not df_z.empty:
        ...
        # Podział danych na bieżące i zarchiwizowane
...
with t4:
    ...
    if df_g is not None and not df_g.empty:
        ...
        with st.expander("⚙️ Admin Gry"):
            ed_g = st.data_editor(df_g, column_config={"Zaliczone": st.column_config.CheckboxColumn("Zaliczone?", default=False)}, hide_index=True, num_rows="dynamic")
...
# ==========================================
with t5:
    st.info("💡 Pamiętaj: F5 zawsze wyczyści te pola. Jeśli przepisałeś formularz celny, dane po prostu giną w niepamięci przeglądarki.")
    ...
    with c_form:
        ...
        # Automatyczny zapis w pamięci przeglądarki

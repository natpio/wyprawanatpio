...
# Licznik dni do wyjazdu i Karta Pokładowa
...
with t5:
    ...
    with c_form:
        ...
        fields = ["c_last", "c_first", "c_dob", "c_mem", "c_street", "c_city", "c_state", "c_pass_country", "c_pass_no", "c_residence", "c_visited", "c_fly", "c_15"]
        values = [c_last, c_first, c_dob, c_mem, c_street, c_city, c_state, c_pass_country, c_pass_no, c_residence, c_visited, c_fly, c_15]
